...
$config['db_dsnw'] = 'mysql://wamdevin_roun966:(86]lpOeS7@localhost/wamdevin_roun966';

// you can define specific table (and sequence) names prefix
$config['db_prefix'] = 'rc5r_';
...
$config['imap_host'] = 'ssl://imap.wamdevin.com:143';
...
$config['smtp_host'] = 'ssl://smtp.wamdevin.com:25';

// provide an URL where a user can get support for this Roundcube installation
// PLEASE DO NOT LINK TO THE ROUNDCUBE.NET WEBSITE HERE!
$config['support_url'] = 'http://wamdevin.com/roundcube';

// This key is used for encrypting purposes, like storing of imap password
// in the session. For historical reasons it's called DES_key, but it's used
// with any configured cipher_method (see below).
// For the default cipher_method a required key length is 24 characters.
$config['des_key'] = 'TPp!w&ybE?C2SGb44n%BANNy';
